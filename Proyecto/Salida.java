...
public class Salida extends JFrame {
  ...
  LblTitle = new JLabel("Factura hecha");
  LblTitle.setFont(new Font("Verdama",Font.BOLD,34));       
  LblTitle.setBounds(500,10,200,180);
  ...
  LblKilos = new JLabel("Servicios");
  LblKilos.setBounds(80,230,100,80);
  
  LblTotal = new JLabel("Total");
  LblTotal.setBounds(80,260,100,80);

  BtnRegistar  =  new JButton ("Continuar");             
  BtnRegistar.setBounds(200,600,180,100); 
